...
| [#24](https://github.com/nicholasmartin/peerpull/issues/24) | Persist referral code across all public pages | Open | Medium | 🟡 Planned — `.agents/plans/gh24-persist-referral-cookie.md`, cookie-based middleware approach |
