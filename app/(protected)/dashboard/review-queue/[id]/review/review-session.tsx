            ...
            {pullRequest.url ? (
              ...
              <div className="flex items-center justify-center h-full text-gray-400">
                <div className="text-center space-y-4">
                  <p className="text-lg">No project URL provided</p>
                  <p className="text-sm">Review the project details below while recording your feedback</p>
                </div>
              </div>
            )}
          </div>
