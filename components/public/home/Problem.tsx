...
// Icon component for problem list items - X circle for problems
const XCircleIcon = () => (
      ...
      <div className="container px-4 md:px-6 mx-auto relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12">
          ...
          <div className="relative bg-dark-card p-8 rounded-lg border border-glass-border shadow-lg backdrop-blur-sm overflow-hidden">
            {/* Subtle gradient highlight - red for problem */}
            <div className="absolute top-0 left-0 h-1 w-full bg-gradient-to-r from-red-500 to-orange-400"></div>
            ...
            <div className="text-center mb-8">
              <h2 className="text-3xl font-bold md:text-4xl mb-3 text-dark-text">The Problem</h2>
              <h3 className="text-xl font-medium text-red-400 mb-4">Building Without Direction</h3>
            </div>
            ...
            <div className="mx-auto">
              ...
              <ul className="space-y-5 my-8">
                <li className="flex items-start gap-4">
                  <div className="bg-red-500/20 text-red-400 border border-red-500/30 rounded-full p-1.5 mt-0.5">
                    <XCircleIcon />
                  </div>
          ...
          <div className="relative bg-dark-card p-8 rounded-lg border border-glass-border shadow-lg backdrop-blur-sm overflow-hidden">
            ...
            <div className="text-center mb-8">
              <h2 className="text-3xl font-bold md:text-4xl mb-3 text-dark-text">The Solution</h2>
