        ...
        <div className="flex flex-col items-center gap-4 md:gap-8 text-center max-w-4xl mx-auto">
          <div className="space-y-5 md:space-y-6">
            ...
            <div className="flex flex-wrap items-center justify-center gap-3">
              <span className="p-[1px] rounded-full bg-gradient-to-r from-blue-primary/40 to-teal-accent/40">
                <span className="inline-flex items-center px-4 py-1.5 rounded-full bg-dark-bg text-sm text-dark-text">1:1 Exchange Ratio</span>
              </span>
              <span className="p-[1px] rounded-full bg-gradient-to-r from-blue-primary/40 to-teal-accent/40">
                <span className="inline-flex items-center px-4 py-1.5 rounded-full bg-dark-bg text-sm text-dark-text">3 Free Credits at Signup</span>
              </span>
              <span className="p-[1px] rounded-full bg-gradient-to-r from-blue-primary/40 to-teal-accent/40">
                <span className="inline-flex items-center px-4 py-1.5 rounded-full bg-dark-bg text-sm text-dark-text">Earn 5 Credits Per Referral</span>
              </span>
            </div>
