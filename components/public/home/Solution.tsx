...
export function Solution() {
  return (
    <section id="solution" className="py-16 md:py-24 bg-prussian-blue text-papaya-whip">
            ...
            <div className="bg-papaya-whip/10 p-8 rounded-xl border border-air-blue/30 shadow-lg">
              ...
              <ol className="space-y-6 counter-reset my-counter">
                ...
                <li className="flex items-start gap-4">
                  ...
                  <div>
                    <p className="font-medium text-papaya-whip">Receive thoughtful feedback in return—usually within hours</p>
                  </div>
                </li>
