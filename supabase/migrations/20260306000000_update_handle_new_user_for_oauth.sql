-- Update handle_new_user() to support OAuth provider metadata
-- Preserves existing logic: signup bonus, referral code generation, onboarding status
-- Adds: OAuth name parsing (full_name, given_name/family_name, picture)
